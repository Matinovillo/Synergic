                        ...
                        @if (Route::has('login'))
                            <div class="top_bar_user">
                                @auth
                                    ...
                                    <div>
                                        <a href="{{ url('/cuenta/datospersonales') }}">
                                            <i class='fas fa-user mr-2 top-bar-icon'></i>Bienvenido!
                                            {{ Auth::user()->nombre }}
                                        </a>
                                    </div>
                                    <span> | </span>
                                ...
                                @else
                                    ...
                                    <button type="button" class="login-button" data-toggle="modal"
            ...
            <div class="row header-row">
                ...
                <div class="col-xl-5 col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <form class="form-inline" method="GET" action="{{ url('productos') }}">
                        <input class="form-control mr-sm-2 inpt" type="search" placeholder="Buscar productos"
                    ...
                    <div class="user-panel">
                        <div class="up-item">
                            <div class="shopping-card">
                                ...
                                @endif
                                <a href="{{ route('cart') }}"
                                    class="@if (Route::has('login')) @auth {{ '' }}  @else {{ 'addtocart' }} @endauth @endif">
            ...
            <div class="grid" id="grid">
                <div class="categorias">
                    ...
                    @foreach ($categorias as $categoria)
                        ...
                        <a href="#" data-categoria="{{ $categoria->id }}">{{ $categoria->nombre }}<i
                    ...
                    <div class="contenido-login">
                        <div class="envolver-login">
                            <form id="formulario-iniciar-sesion">
                                ...
                                {{-- Input contraseña --}}
                                <div class="formulario-campos">
                                    <input id="campoLoginPassword" type="password" class="campos form-control"
                                ...
                                <div class="contenidod-login-formulario-btn">
                                    <button id="btn-enviar-formulario" class="btn btn-lg btn-primary w-100"
                                        type="submit">
                                        Inciar sesion
                                    </button>
                                </div>
