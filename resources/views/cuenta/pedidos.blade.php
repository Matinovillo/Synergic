        ...
        <div class="row">
            <div class="col-lg-12 mt-0">
                <div class="cart_container">
                            ...
                            <ul class="cart_list p-0">
                                <li class="cart_item clearfix">
                                    <div class="cart_item_image">
                                        <img src="/storage/{{ $item->detalle()->first()->detalleProducto()->first()->fotos()->first()->nombre }}"
                                            alt="">
                                    </div>
                    ...
                    @empty
                        <h5 class="text-muted text-center">Parece que todavia no tenes compras realizadas <a
                                href="{{ url('/productos') }}">Ver productos</a></h5>
                    @endforelse
                </div>
                {{ $pedidos->links() }}
            </div>
