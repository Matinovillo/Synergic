                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{ $subcategoria->descripcion }}"
                                    name="descripcion">
                                @error('descripcion')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                                ...
                                <select class="form-control" name="id_categoria_padre">
                                    ...
                                    @foreach ($category as $padre)
                                        <option value="{{ $padre->id }}"
                                            @if ($padre->id == $subcategoria->id_categoria_padre) {{ 'selected' }} @endif>
                                            {{ $padre->nombre }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-12 text-center">
                            ...
                            <a href="{{ route('admin.subcategorias.index') }}" class="btn btn-danger"><i
