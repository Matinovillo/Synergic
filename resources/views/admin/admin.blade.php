         ...
         <tbody>
            ...
            <tr>
               ...
               <td>
                  ...
                  <a href="{{ route('borrarMensaje',$mensaje->id) }}" id="deleteMensaje" data-id="{{ $mensaje->id}}" class="delete-mensaje">
                     <button class="mensaje-delete btn btn-sm btn-danger"><i class="fas fa-trash-alt"></i></button>
                  </a>
               </td>
             </tr>
            @endforeach
