                ...
                <form method="POST" class="mb-5">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="inputCelular4" name="celular"
                                placeholder="Ej: 04519249313">
                            @error('celular')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="inputTelefono4" name="telefono"
                                placeholder="Ej: 4928202">
                            @error('telefono')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="form-group col-xl-12 col-xs-12 col-md-12 col-lg-8 p-0">
                        ...
                        <textarea class="form-control" rows="6" name="mensaje"
                            placeholder="Escribi tu mensaje y nos pondremos en contacto."></textarea>
                        @error('mensaje')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
