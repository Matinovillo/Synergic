...
<section class="admin-table-sec my-2">
  ...
  <?php if (isset($delete)): ?>
    ...
    >
      <?php echo $delete ? '¡Usuario Eliminado!' : '¡No se pudo eliminar el Usuario!' ?>
    </div>
  <?php endif; ?>
    ...
    <tbody>
        ...
        <?php foreach ($usuarios as $usuario): ?>
          <tr scope="row">
            ...
            <td>
              <a title="editar" href="editUser.php?editar=<?php echo $usuario->getUsuario(); ?>"><button class="action-button-edit"><i class="fas fa-pen"></i></button></a>
              <a title="eliminar" href="listadoDeUsuarios.php?eliminar=<?php echo $usuario->getUsuario(); ?>"><button class="action-button-delete"><i class="fas fa-trash-alt"></i></button></a>
            </td>
          </tr>
        <?php endforeach; ?>
