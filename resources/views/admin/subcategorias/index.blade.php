        ...
        <div class="p-2 filter-item3">
            <form action="{{ Route('admin.subcategorias.index') }}" class="form-inline" method="GET">
                ...
                <select id="inputState" class="form-control filter-select" name="orderBy">
                    ...
                    <option value="id_categoria_padre" @if ($order === 'categoria') {{ 'selected' }} @endif>
                        Categoria</option>
        ...
        <div class="p-2 filter-item4">
            <form class="form-inline" action="{{ Route('admin.subcategorias.index') }}">
                <select name="tipo" class="form-control mr-2">
                    ...
                    <option value="id_categoria_padre" @if ($tipo === 'id_categoria_padre') {{ 'selected' }} @endif>
                        Categoria</option>
                </select>
                            ...
                            <tr scope="row">
                                ...
                                <td class="text-left">
                                    <a title="editar" class="mr-2"
                                        href="{{ route('admin.subcategorias.edit', $subcategoria->id) }}">
                                        <button class="btn btn-warning"><i class="fas fa-pen"></i></button>
                                    </a>
                                    <a id="deleteCategoria" data-id="{{ $subcategoria->id }}" class="delete-categoria">
                                        <button class="categoria-delete btn btn-danger"><i
