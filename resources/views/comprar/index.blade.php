                ...
                <form action="{{ Route('cuenta.modificar') }}" method="post" class="needs-validation" novalidate>
                    ...
                    <div class="form-row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('nombre') is-invalid @enderror"
                                id="completarNombre" value="{{ auth()->user()->nombre }}" required name="nombre">
                            @error('nombre')
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('apellido') is-invalid @enderror"
                                id="completarApellido" value="{{ auth()->user()->apellido }}" required name="apellido">
                            @error('apellido')
                                <strong class="text-danger">{{ $message }}</strong>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control @error('email') is-invalid @enderror"
                                    id="completarEmail" value="{{ auth()->user()->email }}"
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="date" class="form-control @error('fecha_nacimiento') is-invalid @enderror"
                                id="completarFecha" value="{{ auth()->user()->fecha_nacimiento }}" required
                    ...
                    <div class="form-row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('calle') is-invalid @enderror" id="completarCalle"
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="text" class="form-control @error('numero') is-invalid @enderror"
                                id="completarNumero" placeholder="Numero" name="numero"
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="text" class="form-control @error('barrio') is-invalid @enderror"
                                id="completarBarrio" placeholder="Barrio" name="barrio"
                    ...
                    <div class="form-row">
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="text" class="form-control @error('codigo_postal') is-invalid @enderror"
                                id="completarCodigo" placeholder="Barrio" name="codigo_postal"
                        ...
                        <div class="col-md-3 mb-3">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('id_provincia') is-invalid @enderror"
                                    id="completarProvincia" placeholder="Pronvincia" name="id_provincia">
                                    {{-- <option value="">provincia</option> --}}
                                    @if (auth()->user()->domicilio()->first() != null)
                                        <option
                                            value="{{ auth()->user()->domicilio()->first()->provincia()->first()->id }}">
                                            {{ auth()->user()->domicilio()->first()->provincia()->first()->nombre }}
                                        </option>
                                    @else
                ...
                <div class="card">
                                ...
                                <li class="list-group-item p-0">
                                    <div class="row producto-row">
                                        <div class="col-4 compra-img-content">
                                            <a
                                                href="{{ route('productoDetail', str_replace(' ', '+', $producto->name)) }}">
                    ...
                    <ul class="list-group list-group-flush d-flex ">
                        <li class="list-group-item d-flex compra-foot">
                            ...
                            <span
                                class="h6 font-weight-bold">${{ number_format(Cart::session(auth()->id())->getTotal(), '2') }}</span>
                        </li>
                        <li class="list-group-item d-flex compra-foot">
