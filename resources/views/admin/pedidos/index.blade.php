        ...
        <div class="p-2 filter-item3">
            <form action="{{ Route('admin.pedidos.index') }}" class="form-inline" method="GET">
                ...
                <select id="inputState" class="form-control filter-select" name="orderBy">
                    ...
                    <option value="forma_pago" @if ($order === 'nombre') {{ 'selected' }} @endif>Forma de pago
                    </option>
        ...
        <div class="p-2 filter-item4">
            <form class="form-inline" action="{{ Route('admin.pedidos.index') }}">
                <select name="tipo" class="form-control mr-2">
                    ...
                    <option value="forma_pago" @if ($tipo === 'forma_pago') {{ 'selected' }} @endif>Forma de pago
                    </option>
                            ...
                            <tr scope="row">
                                ...
                                <td class="d-flex">
                                    ...
                                    <a id="deletePedido" data-id="{{ $pedido->id }}" class="delete-pedido">
                                        <button class="pedido-delete btn btn-danger"><i
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-primary">
                        <h5 class="modal-title text-light" id="exampleModalLabel{{ $pedido->id }}">Detalle del pedido
                            Cod.
                            <b>{{ $pedido->codigo }}</b>
                        </h5>
