                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="email" type="email" class="form-control @error('email') is-invalid @enderror"
                                        name="email" placeholder="E-mail" value="{{ old('email') }}" autocomplete="email">
                                    @error('email')
                        ...
                        <div class="form-row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input id="nombre" type="text" class="form-control @error('nombre') is-invalid @enderror"
                                    name="nombre" placeholder="Nombre" value="{{ old('nombre') }}" autocomplete="nombre"
                                    autofocus>
                                @error('nombre')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input id="apellido" type="text"
                                    ...
                                    placeholder="Apellido" value="{{ old('apellido') }}" autocomplete="apellido"
                                    autofocus>
                                @error('apellido')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="fecha_nacimiento" type="date"
                                        ...
                                        value="{{ old('fecha_nacimiento') }}" autocomplete="fecha_nacimiento">
