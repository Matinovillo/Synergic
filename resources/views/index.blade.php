                    ...
                    <div class="container">
                        <div class="carousel-caption text-left">
                            ...
                            <p><a class="btn btn-lg btn-primary"
                                    href="{{ Route('productosPorCategoria', 'PC+de+escritorio') }}" role="button">Ver pc de
                                    escritorio</a></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="carousel-item">
                    ...
                    <div class="container">
                        <div class="carousel-caption text-right">
                            ...
                            <p>Encontra la <span class="text-primary h6">Notebook</span> que buscas y llevala donde vos
                                quieras</p>
                            ...
                            <div class="card-slider card--1">
                                ...
                                <div class="card__img--hover">
                                    <a href="{{ route('productoDetail', str_replace(' ', '+', $notebook->nombre)) }}"
                                        ...
                                        <img class="card-img-top" src="/storage/{{ $notebook->fotos->first()->nombre }}"
                                            alt="">
                                    </a>
                                </div>
                                <div class="card__info">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="h5">
                                            {{-- boton favorito --}}
                                            <a href="{{ route('favorito.add', $notebook->id) }}"
                                                id="favorite{{ $notebook->id }}"
