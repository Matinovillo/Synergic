...
<form method="post">
	...
	<div class="form-row">
		...
		<div class="col-md-4 mb-3">
			...
			<input type="date" class="form-control" id="" value="{{auth()->user()->fecha_nacimiento}}" required
	...
	<div class="form-row">
		<div class="col-md-6 mb-3">
			...
			<input type="text" class="form-control" id="" placeholder="Calle" name="calle"
		...
		<div class="col-md-3 mb-3">
			...
			<input type="text" class="form-control" id="" placeholder="Barrio" name="barrio"
	...
	<div class="form-row">
		<div class="col-md-3 mb-3">
			...
			<input type="text" class="form-control" id="" placeholder="Barrio" name="codigo_postal"
