...
if (isset($_GET['restore'])) {
  $id=$_GET['restore'];
  $restore = Productos::restoreProduct($id);

}

$productos = Productos::getDeletedProducts();
...
<section class="admin-table-sec my-2">
  ...
  <div class="row">
    <div class="col-xl-12">
  <h2 class="text-center">Productos Elminados</h2>

  <?php if (isset($restore)): ?>
    <div
      class="alert <?php echo $restore ? 'alert-success' : 'alert-danger'?>"
    >
      <?php echo $restore ? '¡Producto restaurado!' : '¡No se pudo Restaurar el producto!' ?>
    </div>
  <?php endif; ?>
    ...
    <tbody>
        ...
        <?php foreach ($productos as $producto): ?>
          <tr scope="row">
            ...
            <td>
              <a title="Restaurar" href="restoreProduct.php?restore=<?php echo $producto->getId(); ?>"><button class="action-button-edit"><i class="fas fa-trash-restore"></i></button></a>
            </td>
          </tr>
        <?php endforeach; ?>
