...
@section('account-content')
    ...
    <div class="row">
                    ...
                    <div class="card-slider card--1 shadow">
                        ...
                        <div class="card__info">
                            ...
                            <span class="card__category">
                                <a href="{{ route('cart.add', $productos->id) }}" class="card__author"
                                    title="Añadir al carrito">
                                    <i class="fas fa-cart-plus"></i>
                                </a>
                            </span>
                            <span class="card__category">
                                <a href="{{ route('favorito.destroy', $productos->id) }}" class="card__author text-danger"
        ...
        @empty
            <div class="container">
                <h5 class="text-muted text-center">Todavia no tenes ningun favorito!
