    ...
    <div class="contenedor contenedor-grid">
      <div class="grid" id="grid">
        <div class="categorias">
          ...
          <a href="productos.php" data-categoria="tecnologia-y-computadoras">Productos<i
              class="fas fa-angle-right"></i></a>
          <a href="#" data-categoria="ropa-y-accesorios">PC de escritorio <i class="fas fa-angle-right"></i></a>
          <a href="#" data-categoria="juegos-y-juguetes">Monitores <i class="fas fa-angle-right"></i></a>
          <a href="#" data-categoria="salud-y-belleza">Perifericos <i class="fas fa-angle-right"></i></a>
        </div>
