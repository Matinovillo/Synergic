...
<div class="container-fluid mt-5">
    <div class="row">
        ...
        <div class="col-12 d-xs-block d-md-none container-fluid">
            <p>
                <button class="btn category-head btn-lg container-fluid" type="button" data-toggle="collapse" data-target="#marca" aria-expanded="false" aria-controls="marca">
                    Categorias
                </button>
            </p>
        ...
        <div class="row">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 mb-4">
                <div class="card h-100 sm-shadow">
                    ...
                    @if($producto->stock<=0 ) <p class="text-muted text-center h5 font-weight-bolder nostock">Sin stock</p>
                        @endif
                        <div class="card-body">
                            <span>Precio:</span>
